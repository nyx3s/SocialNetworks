    ...
    public void run() {
        ...
        try {
            ...
            for(int i = 0; i < 10; i++) {
                ...
                String answerFile = "/home/nyx/Documents/Applied-Social-Network-Analysis-in-Java/data/data/scc_answers/scc_" + (i + 1) + ".txt";
                GraphLoader.loadGraph(g, "/home/nyx/Documents/Applied-Social-Network-Analysis-in-Java/data/data/scc/test_" + (i +1)+ ".txt");
