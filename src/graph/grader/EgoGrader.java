...
public class EgoGrader extends Grader {
    ...
    public void run() {
        try {
            ...
            GraphLoader.loadGraph(graph, "/home/nyx/Documents/Applied-Social-Network-Analysis-in-Java/data/data/facebook_ucsd.txt");
            ...
            for (int i = 0; i < 10; i++) {
                ...
                BufferedReader br = new BufferedReader(new FileReader("/home/nyx/Documents/Applied-Social-Network-Analysis-in-Java/data/data/ego_answers/ego_" + i + ".txt"));
                String next;
